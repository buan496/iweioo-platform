        ...
        <div className="shell home-hero-content">
          ...
          <div className="metrics" aria-label="Site metrics">
            <div className="metric">
              <strong>2</strong>
              <span>{copy.home.metrics.products}</span>
            </div>
            <div className="metric">
              <strong>OIDC</strong>
              <span>{copy.home.metrics.identity}</span>
            </div>
            <div className="metric">
              <strong>µ-unit</strong>
              <span>{copy.home.metrics.usage}</span>
            </div>
          </div>
        </div>
      </section>

      <ProductCatalog locale={locale} labels={copy.home.products} />
